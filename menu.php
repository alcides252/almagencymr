...
<head>
  ...
  <script type="text/javascript">
    ...
    document.write('<link href="styleBlueB.css" rel="stylesheet" type="text/css" media="screen" />');
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Operciones<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Tickets</a></li>
          <li><a href="#">Resultados</a></li>
          <li><a href="#">Gandores</a></li>
        </ul>
      </li>
    ...
    <div class="row" id="show"> 
      <div class="col-sm-3" id="contenResultados">
        <table class="table-striped" id="tablaResultados">
          <?php
            $conn = new mysqli("localhost", "root", "", "loteria");
            $sql="SELECT * FROM resultados WHERE fecha='2018-01-04'";
            $result = mysqli_query($conn,$sql);
            if($result){
              $i=0;
              echo"<tr>";
