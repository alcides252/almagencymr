			...
			for (var i = 0; i < document.loterias.length; i++) {
				if (document.loterias[i].checked==1){
					...
					if(min<55){
						...
						var nombre =  "<td><input id='ticketF' value="+animales[$animal-1]+" type='text' style='width:40%;'></td>"
...
<body onload="document.getElementById('text').focus();">
	<div class="container-fixed">
		...
		<div class="row" id="show">	
			...
			<div class="col-sm-3" id="contenNumeros">
				<table>
					<tr>
						<td>
							<input type="text" id="text" placeholder="Numero" style="width: 60px;" maxlength="2" onkeypress="monto()"  data-toggle="tooltip" title="Ingrese el numero del terminal(00,0-36) o la opcion"/>
						</td>
						<td>
							<input type="text" id="text2" placeholder="Monto" style="width: 60px;" maxlength="5" onkeypress="cargarManual()" data-toggle="tooltip" title="Ingrese el monto(0Bs. - 10.000Bs.)"/>
						</td>
					</tr>
				</table>
				...
				<form method="GET" name="ticketForm"  action="">
					...
					<div  id="divNum" style="height: 200px; overflow-x:hidden; overflow-y:scroll; margin-top: 5px;display: none;">
											...
											if($_GET["idRep"]!=""){
												...
												if($result){
													...
													while ($raw=mysqli_fetch_array($result))
													{
														...
														<td><input id='ticketF' name ='numeros[]'style='margin:0px;' value=".$raw[4]." type='text'readonly></td>
														<td><input id='ticketF' name =''style='margin:0px;width:40%;' value=".$animales[$raw[4]]." type='text'readonly></td>
														<td><input id='ticketF' name ='montos[]' style='margin:0px;width:40%;' value=".$raw[3]." type='text'></td>
